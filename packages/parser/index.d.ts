declare module 'dicom-parser' {
  ...
  export interface Element {
    tag: string;
    /** numeric tag value: (group << 16 | element) >>> 0 */
    tagValue: number;
    vr?: string;
    length: number;
    dataOffset: number;
    /** byte offset where the element's tag begins */
    startOffset: number;
    /** byte offset after the element is fully consumed, including any item/sequence delimiters */
    endOffset: number;
    items?: Element[];
    dataSet?: DataSet;
