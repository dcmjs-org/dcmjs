...
describe('DataSet', () => {
  ...
  describe('#float', () => {
    ...
    it('should return the expected value', () => {
      ...
      // Assert
      expect(float).toBe(-73.00198364257812);
    });
    ...
    it('should return the expected value for a given index', () => {
      ...
      // Assert
      expect(float).toBe(194.53614807128906);
    });
  ...
  describe('#double', () => {
    ...
    it('should return the expected value', () => {
      ...
      // Assert
      expect(double).toBe(-8.8802474352597842181962204226E41);
    });
    ...
    it('should return the expected value for a given index', () => {
      ...
      // Assert
      expect(double).toBe(4.25797335756869935070373891492E81);
    });
  ...
  describe('#attributeTag', () => {
    ...
    it('should return the expected value (LE)', () => {
      ...
      // Assert
      expect(attributeTag).toBe('x00181065');
    });
    ...
    it('should return the expected value (BE)', () => {
      ...
      // Assert
      expect(attributeTag).toBe('x00181063');
    });
