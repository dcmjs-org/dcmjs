...
describe('bigEndianByteArrayParser', () => {
  ...
  describe('#readDouble', () => {
    ...
    it('should return the expected value for first value', () => {
        ...
        // Assert
        expect(doubleValue).toBe(-4.256349017182337e+70);
    });
