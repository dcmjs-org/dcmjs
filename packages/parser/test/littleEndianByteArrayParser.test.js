...
describe('littleEndianByteArrayParser', () => {
  ...
  describe('#readDouble', () => {
    ...
    it('should return the first value', () => {
      ...
      // Assert
      expect(doubleValue).toBe(1.7976931348623157e+308);
    });
    ...
    it('readDouble works on second value', () => {
      ...
      // Assert
      expect(doubleValue).toBe(-1.2129047596099287e+229);
    });
