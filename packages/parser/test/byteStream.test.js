...
describe('ByteStream', () => {
  ...
  describe('#constructor', () => {
    ...
    it('should return a valid object', () => {
      ...
      // Assert
      expect(byteStream).not.toBeUndefined();
    });
    ...
    it('should be at position 0 on creation', () => {
      ...
      // Assert
      expect(byteStream.position).toBe(0);
    });
    ...
    it('should be at position 10 on creation', () => {
      ...
      // Assert
      expect(byteStream.position).toBe(10);
    });
  ...
  describe('#readByteStream', () => {
    ...
    it('should return an object', () => {
      ...
      // Assert
      expect(subByteStream).toBeTruthy();
    });
    ...
    it('should returns an object with same parser', () => {
      ...
      // Assert
      expect(subByteStream.byteArrayParser).toBe(bigEndianByteArrayParser);
    });
    ...
    it('should return an array with size matching numBytes parameter', () => {
      ...
      // Assert
      expect(subByteStream.byteArray.length).toBe(5);
    });
    ...
    it('should returns an object at position 0', () => {
      ...
      // Assert
      expect(subByteStream.position).toBe(0);
    });
  ...
  describe('#readFixedString', () => {
    ...
    it('should set position properly after reading a null terminated string', () => {
      ...
      // Assert
      expect(byteStream.position).toBe(6);
    });
