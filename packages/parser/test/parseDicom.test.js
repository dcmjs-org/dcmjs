...
describe('parseDicom', () => {
  ...
  function assertMetaHeaderElements(dataSet, transferSyntax, groupLength) {
    expect(dataSet.uint32('x00020000')).toBe(groupLength); // '(0002,0000) was not read correctly');
    expect(dataSet.uint16('x00020001')).toBe(256); //'(0002,0001) was not read correctly');
    expect(dataSet.string('x00020002')).toBe('1.2.840.10008.5.1.4.1.1.2'); //'(0002,0002) was not read correctly');
    expect(dataSet.string('x00020003')).toBe('1.2.840.113704.1.111.3512.1336285465.198'); //'(0002,0003) was not read correctly');
    expect(dataSet.string('x00020010')).toBe(transferSyntax); //'(0002,0010) was not read correctly');
    expect(dataSet.string('x00020012')).toBe('1.2.276.0.7230010.3.0.3.6.0'); //'(0002,0012) was not read correctly');
  }
