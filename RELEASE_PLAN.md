...
| `@dcmjs/fhir`                       | Translates between DICOM and FHIR, the data format U.S. regulations require for patient record access. One reviewer has flagged that this may belong later in the landing order — that sequencing question is open, pending confirmation, and the package stays in the plan either way                                                                       | `packages/fhir/`                                                                                                                                                                                                                         | Yes                                                                                                                                                                                                                                              |
...
| 6    | `@dcmjs/dicomdir`, `@dcmjs/pdfs`, `@dcmjs/video`, then the `@dcmjs/media` bundle over them; `@dcmjs/fhir` (sequencing pending reviewer confirmation)                               | Independent of each other once the engines exist; can proceed in parallel. The media bundle lands after its three constituents.                                                                         |
