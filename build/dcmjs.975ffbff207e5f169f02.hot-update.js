...
var Segmentation = function () {
  ...
  _createClass(Segmentation, null, [{
    ...
    value: function generateToolState(imageIds, images, brushData) {
      ...
      var SegmentSequence = dataSet.SegmentSequence;
    ...
    value: function createSegFromImages(images, isMultiframe) {
      ...
      var seg = new dcmjs.derivations.Segmentation([multiframe]);
    }
  }, {
    key: "readToolState",
...
//# sourceMappingURL=dcmjs.975ffbff207e5f169f02.hot-update.js.map