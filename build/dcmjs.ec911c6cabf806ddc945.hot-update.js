    ...
    value: function readToolState(imageIds, arrayBuffer) {
      ...
      if (Array.isArray(segmentSequence)) {
        ...
        for (var z = 0; z < imageIds.length; z++) {
          ...
          _imageIdSpecificToolState.brush.data[0] = {
            invalidated: true,
            pixelData: new Uint8ClampedArray(dims.x * dims.y)
          };

          var _pixelData = _imageIdSpecificToolState.brush.data[0].pixelData;
...
//# sourceMappingURL=dcmjs.ec911c6cabf806ddc945.hot-update.js.map