...
var Segmentation = function (_DerivedPixels2) {
  ...
  _createClass(Segmentation, [{
    ...
    value: function derive() {
      ...
      // TODO: Move this to the example: Slicer tissue green
      /*
      this.dataset.SegmentSequence = [
        {
    ...
    //REQUIRED
    segmentLabel, SegmentedPropertyCategoryCodeSequence, SegmentAlgorithmType,

    //CONDITONALLY OPTIONAL

    //OPTIONAL
    segmentDescription) {

      var SegmentSequence = this.dataset.SegmentSequence;
      var segmentNumber = SegmentSequence.length + 1;
...
//# sourceMappingURL=dcmjs.eb79f78c7c4d8b21264f.hot-update.js.map