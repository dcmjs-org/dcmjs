    ...
    value: function readToolState(imageIds, arrayBuffer) {
      ...
      if (Array.isArray(segmentSequence)) {
        ...
        for (var z = 0; z < imageIds.length; z++) {
          ...
          var _pixelData = _imageIdSpecificToolState.brush.data[segIndex].pixelData;

          for (var p = 0; p < dims.xy; p++) {
            _pixelData[p] = [z * dims.xy + p];
          }

          toolState[imageIds[z]] = _imageIdSpecificToolState;
        }
...
//# sourceMappingURL=dcmjs.6ec0519488fd420a0377.hot-update.js.map