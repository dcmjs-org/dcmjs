  ...
  _createClass(Segmentation, null, [{
    ...
    value: function readToolState(imageIds, arrayBuffer) {
      ...
      if (Array.isArray(segmentSequence)) {
        ...
        for (var _i2 = 0; _i2 < segmentSequence.length; _i2++) {
          segMetadata.push(segmentSequence[_i2]);
        ...
        for (var _z = 0; _z < imageIds.length; _z++) {
          ...
          _imageIdSpecificToolState.brush.data[segIndex] = {
            invalidated: true,
            pixelData: new Uint8ClampedArray(dims.x * dims.y)
          };

          var cToolsPixelData = _imageIdSpecificToolState.brush.data[segIndex].pixelData;

          for (var p = 0; p < dims.xy; p++) {
            cToolsPixelData[p] = pixelData[_z * dims.xy + p];
          }

          toolState[_imageId] = _imageIdSpecificToolState;
        }
      }
...
//# sourceMappingURL=dcmjs.d5251a296376ebfdd61e.hot-update.js.map