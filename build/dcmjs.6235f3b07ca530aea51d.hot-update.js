    ...
    value: function readToolState(imageIds, arrayBuffer) {
      ...
      if (Array.isArray(segmentSequence)) {
        ...
        for (var _i = 0; _i < imageIds.length; _i++) {
          ...
          imageIdSpecificToolState.brush.data[0].pixelData = new Uint8ClampedArray(dims.x * dims.y);

          var _pixelData = imageIdSpecificToolState.brush.data[0].pixelData;

          for (var p = 0; p < dims.x * dims.y; p++) {}

          toolState[imageIds[_i]] = imageIdSpecificToolState;
        }
...
//# sourceMappingURL=dcmjs.6235f3b07ca530aea51d.hot-update.js.map