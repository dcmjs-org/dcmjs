...
var Segmentation = function (_DerivedPixels2) {
  ...
  _createClass(Segmentation, [{
    ...
    value: function derive() {
      ...
      console.log('TEST:');
      console.log(this.referencedDataset['SliceThickness']);
      console.log(this.referencedDataset['PixelMeasuresSequence']);
      console.log(this.referencedDataset['SharedFunctionalGroupsSequence']['PixelMeasuresSequence']);

      this.assignFromReference(["SliceThickness"]);
...
//# sourceMappingURL=dcmjs.3379e9ad5ef2d67d4d3f.hot-update.js.map