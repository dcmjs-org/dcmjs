...
class RTStructureSet {
    constructor(options) {
        ...
        if (options.seriesInstanceUID === undefined) {
            throw new Error(
                "Option 'seriesInstanceUID' is required for RTStructureSet."
            );
        }
        if (options.seriesNumber === undefined) {
            throw new Error(
                "Option 'seriesNumber' is required for RTStructureSet."
            );
        }
        if (options.seriesDescription === undefined) {
            throw new Error(
                "Option 'seriesDescription' is required for RTStructureSet."
            );
        }
        if (options.sopInstanceUID === undefined) {
            throw new Error(
                "Option 'sopInstanceUID' is required for RTStructureSet."
            );
        }
        if (options.instanceNumber === undefined) {
            throw new Error(
                "Option 'instanceNumber' is required for RTStructureSet."
            );
        }
        if (options.manufacturer === undefined) {
            throw new Error(
                "Option 'manufacturer' is required for RTStructureSet."
            );
        }
        // <<<<<<<<<<<<<
        ...
        // NOTE: ContentDate/ContentTime refers to this dcmjs doc instance
