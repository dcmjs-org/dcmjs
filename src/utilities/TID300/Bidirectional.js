...
export default class Bidirectional extends TID300Measurement {
  constructor({longAxis, shortAxis, longAxisLength, shortAxisLength, ReferencedSOPSequence}) {
    super();
  ...
  contentItem() {
    const { longAxis, shortAxis, longAxisLength, shortAxisLength, ReferencedSOPSequence } = this;
